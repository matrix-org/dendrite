...
func (_ZionSpaceManagerGoerli *ZionSpaceManagerGoerliTransactor) CreateChannel(opts *bind.TransactOpts, data DataTypesCreateChannelData, roles []DataTypesCreateRoleEntitlementData) (*types.Transaction, error) {
	return _ZionSpaceManagerGoerli.contract.Transact(opts, "createChannel", data, roles)
}

// CreateChannel is a paid mutator transaction binding the contract method 0xe69689af.
//
// Solidity: function createChannel((string,string,string) data, (uint256,address,bytes)[] roles) returns(uint256 channelId)
func (_ZionSpaceManagerGoerli *ZionSpaceManagerGoerliSession) CreateChannel(data DataTypesCreateChannelData, roles []DataTypesCreateRoleEntitlementData) (*types.Transaction, error) {
	return _ZionSpaceManagerGoerli.Contract.CreateChannel(&_ZionSpaceManagerGoerli.TransactOpts, data, roles)
}

// CreateChannel is a paid mutator transaction binding the contract method 0xe69689af.
//
// Solidity: function createChannel((string,string,string) data, (uint256,address,bytes)[] roles) returns(uint256 channelId)
func (_ZionSpaceManagerGoerli *ZionSpaceManagerGoerliTransactorSession) CreateChannel(data DataTypesCreateChannelData, roles []DataTypesCreateRoleEntitlementData) (*types.Transaction, error) {
	return _ZionSpaceManagerGoerli.Contract.CreateChannel(&_ZionSpaceManagerGoerli.TransactOpts, data, roles)
}
...
func (_ZionSpaceManagerGoerli *ZionSpaceManagerGoerliTransactor) RemoveEntitlement(opts *bind.TransactOpts, spaceNetworkId string, channelNetworkId string, entitlementModuleAddress common.Address, roleId *big.Int, data []byte) (*types.Transaction, error) {
	return _ZionSpaceManagerGoerli.contract.Transact(opts, "removeEntitlement", spaceNetworkId, channelNetworkId, entitlementModuleAddress, roleId, data)
}

// RemoveEntitlement is a paid mutator transaction binding the contract method 0xb53b8167.
//
// Solidity: function removeEntitlement(string spaceNetworkId, string channelNetworkId, address entitlementModuleAddress, uint256 roleId, bytes data) returns()
func (_ZionSpaceManagerGoerli *ZionSpaceManagerGoerliSession) RemoveEntitlement(spaceNetworkId string, channelNetworkId string, entitlementModuleAddress common.Address, roleId *big.Int, data []byte) (*types.Transaction, error) {
	return _ZionSpaceManagerGoerli.Contract.RemoveEntitlement(&_ZionSpaceManagerGoerli.TransactOpts, spaceNetworkId, channelNetworkId, entitlementModuleAddress, roleId, data)
}

// RemoveEntitlement is a paid mutator transaction binding the contract method 0xb53b8167.
//
// Solidity: function removeEntitlement(string spaceNetworkId, string channelNetworkId, address entitlementModuleAddress, uint256 roleId, bytes data) returns()
func (_ZionSpaceManagerGoerli *ZionSpaceManagerGoerliTransactorSession) RemoveEntitlement(spaceNetworkId string, channelNetworkId string, entitlementModuleAddress common.Address, roleId *big.Int, data []byte) (*types.Transaction, error) {
	return _ZionSpaceManagerGoerli.Contract.RemoveEntitlement(&_ZionSpaceManagerGoerli.TransactOpts, spaceNetworkId, channelNetworkId, entitlementModuleAddress, roleId, data)
}
