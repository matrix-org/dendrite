...
func (_ZionSpaceManagerGoerli *ZionSpaceManagerGoerliTransactor) AddRoleIdsToChannel(opts *bind.TransactOpts, spaceId string, channelId string, roleId []*big.Int) (*types.Transaction, error) {
	return _ZionSpaceManagerGoerli.contract.Transact(opts, "addRoleIdsToChannel", spaceId, channelId, roleId)
}

// AddRoleIdsToChannel is a paid mutator transaction binding the contract method 0x81fb7db2.
//
// Solidity: function addRoleIdsToChannel(string spaceId, string channelId, uint256[] roleId) returns()
func (_ZionSpaceManagerGoerli *ZionSpaceManagerGoerliSession) AddRoleIdsToChannel(spaceId string, channelId string, roleId []*big.Int) (*types.Transaction, error) {
	return _ZionSpaceManagerGoerli.Contract.AddRoleIdsToChannel(&_ZionSpaceManagerGoerli.TransactOpts, spaceId, channelId, roleId)
}

// AddRoleIdsToChannel is a paid mutator transaction binding the contract method 0x81fb7db2.
//
// Solidity: function addRoleIdsToChannel(string spaceId, string channelId, uint256[] roleId) returns()
func (_ZionSpaceManagerGoerli *ZionSpaceManagerGoerliTransactorSession) AddRoleIdsToChannel(spaceId string, channelId string, roleId []*big.Int) (*types.Transaction, error) {
	return _ZionSpaceManagerGoerli.Contract.AddRoleIdsToChannel(&_ZionSpaceManagerGoerli.TransactOpts, spaceId, channelId, roleId)
}
...
func (_ZionSpaceManagerGoerli *ZionSpaceManagerGoerliTransactor) AddRoleToEntitlementModule(opts *bind.TransactOpts, spaceNetworkId string, entitlementModuleAddress common.Address, roleId *big.Int, entitlementData []byte) (*types.Transaction, error) {
	return _ZionSpaceManagerGoerli.contract.Transact(opts, "addRoleToEntitlementModule", spaceNetworkId, entitlementModuleAddress, roleId, entitlementData)
}

// AddRoleToEntitlementModule is a paid mutator transaction binding the contract method 0xc79ff589.
//
// Solidity: function addRoleToEntitlementModule(string spaceNetworkId, address entitlementModuleAddress, uint256 roleId, bytes entitlementData) returns()
func (_ZionSpaceManagerGoerli *ZionSpaceManagerGoerliSession) AddRoleToEntitlementModule(spaceNetworkId string, entitlementModuleAddress common.Address, roleId *big.Int, entitlementData []byte) (*types.Transaction, error) {
	return _ZionSpaceManagerGoerli.Contract.AddRoleToEntitlementModule(&_ZionSpaceManagerGoerli.TransactOpts, spaceNetworkId, entitlementModuleAddress, roleId, entitlementData)
}

// AddRoleToEntitlementModule is a paid mutator transaction binding the contract method 0xc79ff589.
//
// Solidity: function addRoleToEntitlementModule(string spaceNetworkId, address entitlementModuleAddress, uint256 roleId, bytes entitlementData) returns()
func (_ZionSpaceManagerGoerli *ZionSpaceManagerGoerliTransactorSession) AddRoleToEntitlementModule(spaceNetworkId string, entitlementModuleAddress common.Address, roleId *big.Int, entitlementData []byte) (*types.Transaction, error) {
	return _ZionSpaceManagerGoerli.Contract.AddRoleToEntitlementModule(&_ZionSpaceManagerGoerli.TransactOpts, spaceNetworkId, entitlementModuleAddress, roleId, entitlementData)
}
...
// CreateRoleWithEntitlementData is a paid mutator transaction binding the contract method 0x40c0df81.
//
// Solidity: function createRoleWithEntitlementData(string spaceNetworkId, string roleName, (string)[] permissions, ((address,uint256,bool,uint256)[])[] tokenEntitlements, address[] users) returns(uint256 roleId)
func (_ZionSpaceManagerGoerli *ZionSpaceManagerGoerliTransactor) CreateRoleWithEntitlementData(opts *bind.TransactOpts, spaceNetworkId string, roleName string, permissions []DataTypesPermission, tokenEntitlements []DataTypesExternalTokenEntitlement, users []common.Address) (*types.Transaction, error) {
	return _ZionSpaceManagerGoerli.contract.Transact(opts, "createRoleWithEntitlementData", spaceNetworkId, roleName, permissions, tokenEntitlements, users)
}

// CreateRoleWithEntitlementData is a paid mutator transaction binding the contract method 0x40c0df81.
//
// Solidity: function createRoleWithEntitlementData(string spaceNetworkId, string roleName, (string)[] permissions, ((address,uint256,bool,uint256)[])[] tokenEntitlements, address[] users) returns(uint256 roleId)
func (_ZionSpaceManagerGoerli *ZionSpaceManagerGoerliSession) CreateRoleWithEntitlementData(spaceNetworkId string, roleName string, permissions []DataTypesPermission, tokenEntitlements []DataTypesExternalTokenEntitlement, users []common.Address) (*types.Transaction, error) {
	return _ZionSpaceManagerGoerli.Contract.CreateRoleWithEntitlementData(&_ZionSpaceManagerGoerli.TransactOpts, spaceNetworkId, roleName, permissions, tokenEntitlements, users)
}

// CreateRoleWithEntitlementData is a paid mutator transaction binding the contract method 0x40c0df81.
//
// Solidity: function createRoleWithEntitlementData(string spaceNetworkId, string roleName, (string)[] permissions, ((address,uint256,bool,uint256)[])[] tokenEntitlements, address[] users) returns(uint256 roleId)
func (_ZionSpaceManagerGoerli *ZionSpaceManagerGoerliTransactorSession) CreateRoleWithEntitlementData(spaceNetworkId string, roleName string, permissions []DataTypesPermission, tokenEntitlements []DataTypesExternalTokenEntitlement, users []common.Address) (*types.Transaction, error) {
	return _ZionSpaceManagerGoerli.Contract.CreateRoleWithEntitlementData(&_ZionSpaceManagerGoerli.TransactOpts, spaceNetworkId, roleName, permissions, tokenEntitlements, users)
}

// CreateSpace is a paid mutator transaction binding the contract method 0x1f2bd9e5.
//
// Solidity: function createSpace((string,string,string) info, (string,(string)[],((address,uint256,bool,uint256)[])[],address[]) entitlementData, (string)[] everyonePermissions) returns(uint256)
...
// ModifyRoleWithEntitlementData is a paid mutator transaction binding the contract method 0x2ca07161.
//
// Solidity: function modifyRoleWithEntitlementData(string spaceNetworkId, uint256 roleId, string roleName, (string)[] permissions, ((address,uint256,bool,uint256)[])[] tokenEntitlements, address[] users) returns(bool isModified)
func (_ZionSpaceManagerGoerli *ZionSpaceManagerGoerliTransactor) ModifyRoleWithEntitlementData(opts *bind.TransactOpts, spaceNetworkId string, roleId *big.Int, roleName string, permissions []DataTypesPermission, tokenEntitlements []DataTypesExternalTokenEntitlement, users []common.Address) (*types.Transaction, error) {
	return _ZionSpaceManagerGoerli.contract.Transact(opts, "modifyRoleWithEntitlementData", spaceNetworkId, roleId, roleName, permissions, tokenEntitlements, users)
}

// ModifyRoleWithEntitlementData is a paid mutator transaction binding the contract method 0x2ca07161.
//
// Solidity: function modifyRoleWithEntitlementData(string spaceNetworkId, uint256 roleId, string roleName, (string)[] permissions, ((address,uint256,bool,uint256)[])[] tokenEntitlements, address[] users) returns(bool isModified)
func (_ZionSpaceManagerGoerli *ZionSpaceManagerGoerliSession) ModifyRoleWithEntitlementData(spaceNetworkId string, roleId *big.Int, roleName string, permissions []DataTypesPermission, tokenEntitlements []DataTypesExternalTokenEntitlement, users []common.Address) (*types.Transaction, error) {
	return _ZionSpaceManagerGoerli.Contract.ModifyRoleWithEntitlementData(&_ZionSpaceManagerGoerli.TransactOpts, spaceNetworkId, roleId, roleName, permissions, tokenEntitlements, users)
}

// ModifyRoleWithEntitlementData is a paid mutator transaction binding the contract method 0x2ca07161.
//
// Solidity: function modifyRoleWithEntitlementData(string spaceNetworkId, uint256 roleId, string roleName, (string)[] permissions, ((address,uint256,bool,uint256)[])[] tokenEntitlements, address[] users) returns(bool isModified)
func (_ZionSpaceManagerGoerli *ZionSpaceManagerGoerliTransactorSession) ModifyRoleWithEntitlementData(spaceNetworkId string, roleId *big.Int, roleName string, permissions []DataTypesPermission, tokenEntitlements []DataTypesExternalTokenEntitlement, users []common.Address) (*types.Transaction, error) {
	return _ZionSpaceManagerGoerli.Contract.ModifyRoleWithEntitlementData(&_ZionSpaceManagerGoerli.TransactOpts, spaceNetworkId, roleId, roleName, permissions, tokenEntitlements, users)
}
...
func (_ZionSpaceManagerGoerli *ZionSpaceManagerGoerliTransactor) RemoveEntitlement(opts *bind.TransactOpts, spaceNetworkId string, entitlementModuleAddress common.Address, roleId *big.Int, data []byte) (*types.Transaction, error) {
	return _ZionSpaceManagerGoerli.contract.Transact(opts, "removeEntitlement", spaceNetworkId, entitlementModuleAddress, roleId, data)
}

// RemoveEntitlement is a paid mutator transaction binding the contract method 0xd6b1b633.
//
// Solidity: function removeEntitlement(string spaceNetworkId, address entitlementModuleAddress, uint256 roleId, bytes data) returns()
func (_ZionSpaceManagerGoerli *ZionSpaceManagerGoerliSession) RemoveEntitlement(spaceNetworkId string, entitlementModuleAddress common.Address, roleId *big.Int, data []byte) (*types.Transaction, error) {
	return _ZionSpaceManagerGoerli.Contract.RemoveEntitlement(&_ZionSpaceManagerGoerli.TransactOpts, spaceNetworkId, entitlementModuleAddress, roleId, data)
}

// RemoveEntitlement is a paid mutator transaction binding the contract method 0xd6b1b633.
//
// Solidity: function removeEntitlement(string spaceNetworkId, address entitlementModuleAddress, uint256 roleId, bytes data) returns()
func (_ZionSpaceManagerGoerli *ZionSpaceManagerGoerliTransactorSession) RemoveEntitlement(spaceNetworkId string, entitlementModuleAddress common.Address, roleId *big.Int, data []byte) (*types.Transaction, error) {
	return _ZionSpaceManagerGoerli.Contract.RemoveEntitlement(&_ZionSpaceManagerGoerli.TransactOpts, spaceNetworkId, entitlementModuleAddress, roleId, data)
}
...
func (_ZionSpaceManagerGoerli *ZionSpaceManagerGoerliTransactor) RemoveRoleIdsFromChannel(opts *bind.TransactOpts, spaceId string, channelId string, roleId []*big.Int) (*types.Transaction, error) {
	return _ZionSpaceManagerGoerli.contract.Transact(opts, "removeRoleIdsFromChannel", spaceId, channelId, roleId)
}

// RemoveRoleIdsFromChannel is a paid mutator transaction binding the contract method 0x7a40ab90.
//
// Solidity: function removeRoleIdsFromChannel(string spaceId, string channelId, uint256[] roleId) returns()
func (_ZionSpaceManagerGoerli *ZionSpaceManagerGoerliSession) RemoveRoleIdsFromChannel(spaceId string, channelId string, roleId []*big.Int) (*types.Transaction, error) {
	return _ZionSpaceManagerGoerli.Contract.RemoveRoleIdsFromChannel(&_ZionSpaceManagerGoerli.TransactOpts, spaceId, channelId, roleId)
}

// RemoveRoleIdsFromChannel is a paid mutator transaction binding the contract method 0x7a40ab90.
//
// Solidity: function removeRoleIdsFromChannel(string spaceId, string channelId, uint256[] roleId) returns()
func (_ZionSpaceManagerGoerli *ZionSpaceManagerGoerliTransactorSession) RemoveRoleIdsFromChannel(spaceId string, channelId string, roleId []*big.Int) (*types.Transaction, error) {
	return _ZionSpaceManagerGoerli.Contract.RemoveRoleIdsFromChannel(&_ZionSpaceManagerGoerli.TransactOpts, spaceId, channelId, roleId)
}
