...
// DataTypesCreateRoleEntitlementData is an auto generated low-level Go binding around an user-defined struct.
type DataTypesCreateRoleEntitlementData struct {
	RoleId            *big.Int
	EntitlementModule common.Address
...
// CreateChannel is a paid mutator transaction binding the contract method 0xe69689af.
//
// Solidity: function createChannel((string,string,string) data, (uint256,address,bytes)[] roles) returns(uint256 channelId)
func (_ZionSpaceManagerLocalhost *ZionSpaceManagerLocalhostTransactor) CreateChannel(opts *bind.TransactOpts, data DataTypesCreateChannelData, roles []DataTypesCreateRoleEntitlementData) (*types.Transaction, error) {
	return _ZionSpaceManagerLocalhost.contract.Transact(opts, "createChannel", data, roles)
}

// CreateChannel is a paid mutator transaction binding the contract method 0xe69689af.
//
// Solidity: function createChannel((string,string,string) data, (uint256,address,bytes)[] roles) returns(uint256 channelId)
func (_ZionSpaceManagerLocalhost *ZionSpaceManagerLocalhostSession) CreateChannel(data DataTypesCreateChannelData, roles []DataTypesCreateRoleEntitlementData) (*types.Transaction, error) {
	return _ZionSpaceManagerLocalhost.Contract.CreateChannel(&_ZionSpaceManagerLocalhost.TransactOpts, data, roles)
}

// CreateChannel is a paid mutator transaction binding the contract method 0xe69689af.
//
// Solidity: function createChannel((string,string,string) data, (uint256,address,bytes)[] roles) returns(uint256 channelId)
func (_ZionSpaceManagerLocalhost *ZionSpaceManagerLocalhostTransactorSession) CreateChannel(data DataTypesCreateChannelData, roles []DataTypesCreateRoleEntitlementData) (*types.Transaction, error) {
	return _ZionSpaceManagerLocalhost.Contract.CreateChannel(&_ZionSpaceManagerLocalhost.TransactOpts, data, roles)
}
...
// RemoveEntitlement is a paid mutator transaction binding the contract method 0xb53b8167.
//
// Solidity: function removeEntitlement(string spaceNetworkId, string channelNetworkId, address entitlementModuleAddress, uint256 roleId, bytes data) returns()
func (_ZionSpaceManagerLocalhost *ZionSpaceManagerLocalhostTransactor) RemoveEntitlement(opts *bind.TransactOpts, spaceNetworkId string, channelNetworkId string, entitlementModuleAddress common.Address, roleId *big.Int, data []byte) (*types.Transaction, error) {
	return _ZionSpaceManagerLocalhost.contract.Transact(opts, "removeEntitlement", spaceNetworkId, channelNetworkId, entitlementModuleAddress, roleId, data)
}

// RemoveEntitlement is a paid mutator transaction binding the contract method 0xb53b8167.
//
// Solidity: function removeEntitlement(string spaceNetworkId, string channelNetworkId, address entitlementModuleAddress, uint256 roleId, bytes data) returns()
func (_ZionSpaceManagerLocalhost *ZionSpaceManagerLocalhostSession) RemoveEntitlement(spaceNetworkId string, channelNetworkId string, entitlementModuleAddress common.Address, roleId *big.Int, data []byte) (*types.Transaction, error) {
	return _ZionSpaceManagerLocalhost.Contract.RemoveEntitlement(&_ZionSpaceManagerLocalhost.TransactOpts, spaceNetworkId, channelNetworkId, entitlementModuleAddress, roleId, data)
}

// RemoveEntitlement is a paid mutator transaction binding the contract method 0xb53b8167.
//
// Solidity: function removeEntitlement(string spaceNetworkId, string channelNetworkId, address entitlementModuleAddress, uint256 roleId, bytes data) returns()
func (_ZionSpaceManagerLocalhost *ZionSpaceManagerLocalhostTransactorSession) RemoveEntitlement(spaceNetworkId string, channelNetworkId string, entitlementModuleAddress common.Address, roleId *big.Int, data []byte) (*types.Transaction, error) {
	return _ZionSpaceManagerLocalhost.Contract.RemoveEntitlement(&_ZionSpaceManagerLocalhost.TransactOpts, spaceNetworkId, channelNetworkId, entitlementModuleAddress, roleId, data)
}
