...
func (_ZionSpaceManagerLocalhost *ZionSpaceManagerLocalhostTransactor) CreateRoleWithEntitlementData(opts *bind.TransactOpts, spaceNetworkId string, roleName string, permissions []DataTypesPermission, tokenEntitlements []DataTypesExternalTokenEntitlement, users []common.Address) (*types.Transaction, error) {
	return _ZionSpaceManagerLocalhost.contract.Transact(opts, "createRoleWithEntitlementData", spaceNetworkId, roleName, permissions, tokenEntitlements, users)
}

// CreateRoleWithEntitlementData is a paid mutator transaction binding the contract method 0x40c0df81.
//
// Solidity: function createRoleWithEntitlementData(string spaceNetworkId, string roleName, (string)[] permissions, ((address,uint256,bool,uint256)[])[] tokenEntitlements, address[] users) returns(uint256 roleId)
func (_ZionSpaceManagerLocalhost *ZionSpaceManagerLocalhostSession) CreateRoleWithEntitlementData(spaceNetworkId string, roleName string, permissions []DataTypesPermission, tokenEntitlements []DataTypesExternalTokenEntitlement, users []common.Address) (*types.Transaction, error) {
	return _ZionSpaceManagerLocalhost.Contract.CreateRoleWithEntitlementData(&_ZionSpaceManagerLocalhost.TransactOpts, spaceNetworkId, roleName, permissions, tokenEntitlements, users)
}

// CreateRoleWithEntitlementData is a paid mutator transaction binding the contract method 0x40c0df81.
//
// Solidity: function createRoleWithEntitlementData(string spaceNetworkId, string roleName, (string)[] permissions, ((address,uint256,bool,uint256)[])[] tokenEntitlements, address[] users) returns(uint256 roleId)
func (_ZionSpaceManagerLocalhost *ZionSpaceManagerLocalhostTransactorSession) CreateRoleWithEntitlementData(spaceNetworkId string, roleName string, permissions []DataTypesPermission, tokenEntitlements []DataTypesExternalTokenEntitlement, users []common.Address) (*types.Transaction, error) {
	return _ZionSpaceManagerLocalhost.Contract.CreateRoleWithEntitlementData(&_ZionSpaceManagerLocalhost.TransactOpts, spaceNetworkId, roleName, permissions, tokenEntitlements, users)
}
...
func (_ZionSpaceManagerLocalhost *ZionSpaceManagerLocalhostTransactor) ModifyRoleWithEntitlementData(opts *bind.TransactOpts, spaceNetworkId string, roleId *big.Int, roleName string, permissions []DataTypesPermission, tokenEntitlements []DataTypesExternalTokenEntitlement, users []common.Address) (*types.Transaction, error) {
	return _ZionSpaceManagerLocalhost.contract.Transact(opts, "modifyRoleWithEntitlementData", spaceNetworkId, roleId, roleName, permissions, tokenEntitlements, users)
}

// ModifyRoleWithEntitlementData is a paid mutator transaction binding the contract method 0x2ca07161.
//
// Solidity: function modifyRoleWithEntitlementData(string spaceNetworkId, uint256 roleId, string roleName, (string)[] permissions, ((address,uint256,bool,uint256)[])[] tokenEntitlements, address[] users) returns(bool isModified)
func (_ZionSpaceManagerLocalhost *ZionSpaceManagerLocalhostSession) ModifyRoleWithEntitlementData(spaceNetworkId string, roleId *big.Int, roleName string, permissions []DataTypesPermission, tokenEntitlements []DataTypesExternalTokenEntitlement, users []common.Address) (*types.Transaction, error) {
	return _ZionSpaceManagerLocalhost.Contract.ModifyRoleWithEntitlementData(&_ZionSpaceManagerLocalhost.TransactOpts, spaceNetworkId, roleId, roleName, permissions, tokenEntitlements, users)
}

// ModifyRoleWithEntitlementData is a paid mutator transaction binding the contract method 0x2ca07161.
//
// Solidity: function modifyRoleWithEntitlementData(string spaceNetworkId, uint256 roleId, string roleName, (string)[] permissions, ((address,uint256,bool,uint256)[])[] tokenEntitlements, address[] users) returns(bool isModified)
func (_ZionSpaceManagerLocalhost *ZionSpaceManagerLocalhostTransactorSession) ModifyRoleWithEntitlementData(spaceNetworkId string, roleId *big.Int, roleName string, permissions []DataTypesPermission, tokenEntitlements []DataTypesExternalTokenEntitlement, users []common.Address) (*types.Transaction, error) {
	return _ZionSpaceManagerLocalhost.Contract.ModifyRoleWithEntitlementData(&_ZionSpaceManagerLocalhost.TransactOpts, spaceNetworkId, roleId, roleName, permissions, tokenEntitlements, users)
}
