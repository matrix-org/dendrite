...
// CreateSpaceWithTokenEntitlement is a paid mutator transaction binding the contract method 0x8f720f1e.
//
// Solidity: function createSpaceWithTokenEntitlement((string,string) info, (address,uint256,string,bool,uint256,string[],string) entitlement) returns(uint256)
