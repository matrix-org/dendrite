...
// AddPermissionToRole is a paid mutator transaction binding the contract method 0x4dad3a74.
//
// Solidity: function addPermissionToRole(uint256 _roleId, string[] _permissions) returns()
func (_LocalhostSpace *LocalhostSpaceTransactor) AddPermissionToRole(opts *bind.TransactOpts, _roleId *big.Int, _permissions []string) (*types.Transaction, error) {
	return _LocalhostSpace.contract.Transact(opts, "addPermissionToRole", _roleId, _permissions)
}

// AddPermissionToRole is a paid mutator transaction binding the contract method 0x4dad3a74.
//
// Solidity: function addPermissionToRole(uint256 _roleId, string[] _permissions) returns()
func (_LocalhostSpace *LocalhostSpaceSession) AddPermissionToRole(_roleId *big.Int, _permissions []string) (*types.Transaction, error) {
	return _LocalhostSpace.Contract.AddPermissionToRole(&_LocalhostSpace.TransactOpts, _roleId, _permissions)
}

// AddPermissionToRole is a paid mutator transaction binding the contract method 0x4dad3a74.
//
// Solidity: function addPermissionToRole(uint256 _roleId, string[] _permissions) returns()
func (_LocalhostSpace *LocalhostSpaceTransactorSession) AddPermissionToRole(_roleId *big.Int, _permissions []string) (*types.Transaction, error) {
	return _LocalhostSpace.Contract.AddPermissionToRole(&_LocalhostSpace.TransactOpts, _roleId, _permissions)
}
