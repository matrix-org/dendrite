...
const KeyID = "ed25519:dendrite-demo-pinecone"

type PineconeKeys struct {
}

func (f *PineconeKeys) KeyRing() *gomatrixserverlib.KeyRing {
	return &gomatrixserverlib.KeyRing{
		KeyDatabase: f,
	}
}

func (f *PineconeKeys) FetchKeys(
	ctx context.Context,
...
func (f *PineconeKeys) FetcherName() string {
	return "PineconeKeys"
}

func (f *PineconeKeys) StoreKeys(ctx context.Context, results map[gomatrixserverlib.PublicKeyLookupRequest]gomatrixserverlib.PublicKeyLookupResult) error {
	return nil
}
