...
func (s *outputRoomEventsStatements) selectStateInRange(
	...
	defer common.LogIfError(ctx, rows.Close(), "selectStateInRange: rows.close() failed")
...
func (s *outputRoomEventsStatements) selectRecentEvents(
	...
	defer common.LogIfError(ctx, rows.Close(), "selectRecentEvents: rows.close() failed")
...
func (s *outputRoomEventsStatements) selectEarlyEvents(
	...
	defer common.LogIfError(ctx, rows.Close(), "selectEarlyEvents: rows.close() failed")
	events, err := rowsToStreamEvents(rows)
	if err != nil {
		return nil, err
	}
...
func (s *outputRoomEventsStatements) selectEvents(
	...
	defer common.LogIfError(ctx, rows.Close(), "selectEvents: rows.close() failed")
