...
func TestSyncTokens(t *testing.T) {
	shouldPass := map[string]string{
		...
		"s3_1_0_0_0_0_2_1": StreamingToken{3, 1, 0, 0, 0, 0, 2, 1}.String(),
		"s3_1_2_3_5_0_0_3": StreamingToken{3, 1, 2, 3, 5, 0, 0, 3}.String(),
		"s3_1_2_3_4_5_6_7": StreamingToken{3, 1, 2, 3, 4, 5, 6, 7}.String(),
