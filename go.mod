...
replace github.com/matrix-org/gomatrixserverlib => ../../../gomatrixserverlib/s7evink/memberships/
...
require (
	...
	github.com/matrix-org/gomatrixserverlib v0.0.0-20230706213828-fa6d5ca0e184
