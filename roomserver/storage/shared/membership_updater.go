...
func NewMembershipUpdater(
	...
	err = d.Writer.Do(d.DB, txn, func(txn *sql.Tx) error {
		roomNID, err = d.assignRoomNID(ctx, nil, roomID, roomVersion)
		if err != nil {
			return err
		}

		targetUserNID, err = d.assignStateKeyNID(ctx, nil, targetUserID)
		if err != nil {
			return err
		}
		return nil
...
func (u *MembershipUpdater) SetToInvite(event gomatrixserverlib.Event) (bool, error) {
	...
	err := u.d.Writer.Do(u.d.DB, u.txn, func(txn *sql.Tx) error {
		senderUserNID, err := u.d.assignStateKeyNID(u.ctx, nil, event.Sender())
		if err != nil {
...
func (u *MembershipUpdater) SetToJoin(senderUserID string, eventID string, isUpdate bool) ([]string, error) {
	...
	err := u.d.Writer.Do(u.d.DB, u.txn, func(txn *sql.Tx) error {
		senderUserNID, err := u.d.assignStateKeyNID(u.ctx, nil, senderUserID)
		if err != nil {
			return fmt.Errorf("u.d.AssignStateKeyNID: %w", err)
		}
