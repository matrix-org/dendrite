...
func (u *MembershipUpdater) SetToInvite(event gomatrixserverlib.Event) (bool, error) {
	...
	err := u.d.Writer.Do(u.d.DB, u.txn, func(txn *sql.Tx) error {
		...
		if u.membership != tables.MembershipStateInvite {
			if err = u.d.MembershipTable.UpdateMembership(u.ctx, u.txn, u.roomNID, u.targetUserNID, senderUserNID, tables.MembershipStateInvite, 0, false, nil); err != nil {
...
func (u *MembershipUpdater) SetToLeave(senderUserID string, eventID string) ([]string, error) {
	...
	err := u.d.Writer.Do(u.d.DB, u.txn, func(txn *sql.Tx) error {
		...
		if u.membership != tables.MembershipStateLeaveOrBan {
			if err = u.d.MembershipTable.UpdateMembership(u.ctx, u.txn, u.roomNID, u.targetUserNID, senderUserNID, tables.MembershipStateLeaveOrBan, nIDs[eventID], false, nil); err != nil {
				return fmt.Errorf("u.d.MembershipTable.UpdateMembership: %w", err)
			}
		}
