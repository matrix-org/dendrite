...
func (s *eventStatements) bulkSelectStateEventByID(
	...
	defer common.LogIfError(ctx, rows.Close(), "bulkSelectStateEventByID: rows.close() failed")
...
func (s *eventStatements) bulkSelectStateAtEventByID(
	...
	defer common.LogIfError(ctx, rows.Close(), "bulkSelectStateAtEventByID: rows.close() failed")
...
func (s *eventStatements) bulkSelectStateAtEventAndReference(
	...
	defer common.LogIfError(ctx, rows.Close(), "bulkSelectStateAtEventAndReference: rows.close() failed")
...
func (s *eventStatements) bulkSelectEventReference(
	...
	defer common.LogIfError(ctx, rows.Close(), "bulkSelectEventReference: rows.close() failed")
...
func (s *eventStatements) bulkSelectEventID(ctx context.Context, txn *sql.Tx, eventNIDs []types.EventNID) (map[types.EventNID]string, error) {
	...
	defer common.LogIfError(ctx, rows.Close(), "bulkSelectEventID: rows.close() failed")
...
func (s *eventStatements) bulkSelectEventNID(ctx context.Context, txn *sql.Tx, eventIDs []string) (map[string]types.EventNID, error) {
	...
	defer common.LogIfError(ctx, rows.Close(), "bulkSelectEventNID: rows.close() failed")
