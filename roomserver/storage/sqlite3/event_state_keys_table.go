...
func (s *eventStateKeyStatements) bulkSelectEventStateKeyNID(
	...
	defer common.LogIfError(ctx, rows.Close(), "bulkSelectEventStateKeyNID: rows.close() failed")
...
func (s *eventStateKeyStatements) bulkSelectEventStateKey(
	...
	defer common.LogIfError(ctx, rows.Close(), "bulkSelectEventStateKey: rows.close() failed")
